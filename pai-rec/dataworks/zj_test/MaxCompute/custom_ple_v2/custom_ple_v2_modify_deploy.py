  ...
  'storage': [
    {
      ...
      'oss': {
        'path': f"oss://prd-pai-rec/EasyRec/deploy/song_scene_v2_custom_ple_v2/{args['ymd']}/export/final_with_fg",
        'readOnly': False
      },
      'properties': {
        'resource_type': 'code'
    ...
    },
    {
        "mount_path": "/warmup",
        "oss": {
            "path": "oss://prd-pai-rec/EasyRec/deploy/song_scene_v2_custom_ple_v2/song_scene_pb_file_path",
            "readOnly": False
        }
    }
  ],
