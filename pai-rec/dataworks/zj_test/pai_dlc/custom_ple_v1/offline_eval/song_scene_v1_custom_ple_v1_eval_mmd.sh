...
dlc submit pytorchjob \
    --name=song_scene_v1_custom_ple_v1_eval_mmd \
    --command='set -e
        ...
        --eval_input_path odps://dws_rec/tables/song_scene_config_pyfg_encoded_v1_handle_scene_weight_mmd/p_date=${eval_ymd}' \
...
# 传参配置
# model_name=zhengjian_test/song_scene_v1_custom_ple_v1,model_ymd=20260505,eval_ymd=20260506    
