...
--********************************************************************--
CREATE TABLE IF NOT EXISTS dws_rec.song_scene_config_pyfg_encoded_v2_handle_scene_weight_11towers
(
    request_id                                                                          STRING
    ...
    ,mmd_is_valid                                                                       BIGINT
    ,mmd_is_full                                                                        BIGINT
    ,mmd_play_duration                                                                  BIGINT
    ,ps_is_click                                                                        BIGINT
    ,ps_is_valid                                                                        BIGINT
    ,ps_is_full                                                                         BIGINT
    ,ps_play_duration                                                                   BIGINT
    ,dr_is_click                                                                        BIGINT
    ,dr_is_valid                                                                        BIGINT
    ,dr_is_full                                                                         BIGINT
    ,dr_play_duration                                                                   BIGINT
    ,mmd_is_valid_weight                                                                DOUBLE
    ,mmd_is_full_weight                                                                 DOUBLE
    ,mmd_play_duration_weight                                                           DOUBLE
    ,ps_is_click_weight                                                                 DOUBLE
    ,ps_is_valid_weight                                                                 DOUBLE
    ,ps_is_full_weight                                                                  DOUBLE
    ,ps_play_duration_weight                                                            DOUBLE
    ,dr_is_click_weight                                                                 DOUBLE
    ,dr_is_valid_weight                                                                 DOUBLE
    ,dr_is_full_weight                                                                  DOUBLE
    ,dr_play_duration_weight                                                            DOUBLE
...
INSERT OVERWRITE TABLE dws_rec.song_scene_config_pyfg_encoded_v2_handle_scene_weight_11towers PARTITION (p_date = '${bdp.system.bizdate}')
SELECT  request_id
        ,__identity_id__
        ,__item_id__
        ,is_valid AS mmd_is_valid
        ,is_full AS mmd_is_full
        ,play_duration AS mmd_play_duration
        ,is_click AS ps_is_click
        ,is_valid AS ps_is_valid
        ,is_full AS ps_is_full
        ,play_duration AS ps_play_duration
        ,is_click AS dr_is_click
        ,is_valid AS dr_is_valid
        ,is_full AS dr_is_full
        ,play_duration AS dr_play_duration
        ,IF(event_scene_id[0] = 'musicModelDefault',1,0) AS mmd_is_valid_weight
        ,IF(event_scene_id[0] = 'musicModelDefault',1,0) AS mmd_is_full_weight
        ,IF(event_scene_id[0] = 'musicModelDefault',1,0) AS mmd_play_duration_weight
        ,IF(event_scene_id[0] = 'personalSong',1,0) AS ps_is_click_weight
        ,IF(event_scene_id[0] = 'personalSong',1,0) AS ps_is_valid_weight
        ,IF(event_scene_id[0] = 'personalSong',1,0) AS ps_is_full_weight
        ,IF(event_scene_id[0] = 'personalSong',1,0) AS ps_play_duration_weight
        ,IF(event_scene_id[0] = 'dailyReco',1,0) AS dr_is_click_weight
        ,IF(event_scene_id[0] = 'dailyReco',1,0) AS dr_is_valid_weight
        ,IF(event_scene_id[0] = 'dailyReco',1,0) AS dr_is_full_weight
        ,IF(event_scene_id[0] = 'dailyReco',1,0) AS dr_play_duration_weight -- ,CASE   WHEN event_scene_id[0] = 'dailyReco' THEN 1.0
