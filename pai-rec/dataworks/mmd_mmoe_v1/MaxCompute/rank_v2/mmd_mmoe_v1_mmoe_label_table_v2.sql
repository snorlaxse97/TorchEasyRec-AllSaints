CREATE TABLE IF NOT EXISTS dws_rec.mmd_mmoe_v1_mmoe_label_table_v2
(
    request_id       STRING
...
(
    ...
    AND     event_scene_id = 'music_model_default'
    GROUP BY request_id
             ,identity_id
             ,item_id
             ,event_scene_id
)
INSERT OVERWRITE TABLE mmd_mmoe_v1_mmoe_label_table_v2 PARTITION (p_date = '${bdp.system.bizdate}')
SELECT  request_id
        ,t2.identity_id
        ,__identity_id__
        ,item_id
